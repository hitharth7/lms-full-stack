...
const CourseDetails = () => {
  ...
  const { courses, isEnrolled, isAuthenticated } = useContext(AppContext);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex flex-col lg:flex-row gap-8 relative items-start">
              ...
              <div className="flex justify-between items-end mb-4">
                <div>
                  ...
                  <p className="text-xs text-gray-400 mt-1 font-semibold">
                    {course.chapters.length} sections &bull; {course.lecturesCount} lectures &bull; {formatCourseDuration(course.duration)} total duration
                  </p>
                </div>
              </div>
                          ...
                          {chapter.chapterContent.map((lecture) => (
                            <div key={lecture.lectureId} className="flex justify-between items-center px-6 py-3.5 hover:bg-gray-50/40 transition-colors">
                              ...
                              <div className="flex items-center gap-4">
                                ...
                                <span className="text-xs text-gray-400 font-medium">{formatCourseDuration(lecture.lectureDuration)}</span>
                              </div>
                            </div>
                          ))}
                        </div>
          ...
          <div className="w-full lg:w-80 lg:sticky lg:top-20 flex-shrink-0 border border-gray-100 rounded-3xl overflow-hidden bg-white shadow-xl">
            ...
            <div 
              className={`w-full h-52 relative overflow-hidden flex items-center justify-center course-thumbnail-frame ${
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="space-y-3.5 pt-4 border-t border-gray-50 text-xs text-gray-500 font-medium">
                ...
                <div className="flex items-center gap-2.5">
                  ...
                  <span>{formatCourseDuration(course.duration)} video playback</span>
                </div>
                <div className="flex items-center gap-2.5">
