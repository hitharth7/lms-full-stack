...
const AddCourse = () => {
  ...
  // Thumbnail Options
  const thumbnails = [
    { label: "Ocean Blue", value: "linear-gradient(135deg, #0ea5e9 0%, #2563eb 100%)" },
    { label: "Cosmic Purple", value: "linear-gradient(135deg, #a855f7 0%, #6366f1 100%)" },
    { label: "Sunset Amber", value: "linear-gradient(135deg, #f59e0b 0%, #d97706 100%)" },
    { label: "Emerald Forest", value: "linear-gradient(135deg, #10b981 0%, #047857 100%)" },
    { label: "Rose Petal", value: "linear-gradient(135deg, #f43f5e 0%, #be123c 100%)" },
  ];
              ...
              <div className="flex flex-wrap gap-2 pt-1">
                {thumbnails.map((t) => (
                  <button
                    ...
                    title={t.label}
                    className={`w-9 h-9 rounded-xl flex items-center justify-center text-white shadow-sm transition-all cursor-pointer hover:scale-105 ${
